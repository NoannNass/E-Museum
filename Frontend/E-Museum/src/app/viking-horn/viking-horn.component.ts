...
@Component({
  selector: 'app-viking-horn',
  imports: [],
  templateUrl: './viking-horn.component.html',
  styleUrl: './viking-horn.component.css'
})
export class VikingHornComponent implements OnInit, OnDestroy  {
  ...
  private initPilier() {
    const canvas = document.getElementById('pillier8') as HTMLCanvasElement;
    if (!canvas) {
  ...
  private initThreeJS() {
    const canvas = document.getElementById('model8') as HTMLCanvasElement;
    if (!canvas) {
