...
@Component({
  selector: 'app-viking-casque',
  imports: [],
  templateUrl: './viking-casque.component.html',
  styleUrl: './viking-casque.component.css'
})
export class VikingCasqueComponent implements OnInit, OnDestroy  {
  ...
  private initPilier() {
    const canvas = document.getElementById('pillier6') as HTMLCanvasElement;
    if (!canvas) {
  ...
  private initThreeJS() {
    const canvas = document.getElementById('model6') as HTMLCanvasElement;
    if (!canvas) {
